...
test.describe("Avatar Visual Snapshots", () => {
	...
	test.describe("Avatar Groups", () => {
		test("avatar group", async ({ page }) => {
			const group = page.locator(DEMO).locator('div[role="group"]').first();
