...
test.describe("Select Visual Snapshots", () => {
	...
	test.describe("Select with Groups", () => {
		test("grouped select", async ({ page }) => {
			const select = page.locator(DEMO).locator("select").last();
